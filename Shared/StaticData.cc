...
std::array<struct MobData, MobID::kNumMobs> const MOB_DATA = {{
    ...
    },
    {
        ...
        .xp = 2,
        .drops = {
            PetalID::kLight, PetalID::kTwin, PetalID::kLeaf, PetalID::kPeas, PetalID::kTriplet, PetalID::kPoisonPeas, PetalID::kPoisonPeas2, PetalID::kQuint
        },
        .attributes = {
            .segments = 10
        }
    ...
    },
    {
        ...
        .xp = 25,
        .drops = {
            PetalID::kIris, PetalID::kWing, PetalID::kAntEgg, PetalID::kTriplet, PetalID::kQuint, PetalID::kTriWing, PetalID::kBone
        },
        .attributes = {
            .stationary = 1 
        }
    },
    {
        ...
        .xp = 15,
        .drops = {
            PetalID::kTwin, PetalID::kIris, PetalID::kWing, PetalID::kAntEgg, PetalID::kTringer, PetalID::kQuint, PetalID::kTriWing
        },
        .attributes = {
            .aggro_radius = 750
        }
